-- ================================================================
-- TDS Codes Master v2 — Full Official Rates
...
-- 192A: PF withdrawal
('192A', NULL, 'Payment of accumulated balance of provident fund taxable in hands of employee', 'ALL', 1, 10.000, 5000000, 'Threshold: Rs. 50,000', 'Form 16A', NULL),
...
-- 194: Dividend
('194', NULL, 'Income by way of dividend', 'ALL', 1, 10.000, 500000, 'Threshold: Rs. 5,000', 'Form 16A', NULL),

-- 194A: Interest other than securities
('194A', NULL, 'Income by way of interest other than interest on securities', 'ALL', 1, 10.000, 4000000, 'Threshold: Rs. 40,000 (Rs. 50,000 for senior citizens)', 'Form 16A', NULL),

-- 194B: Lottery winnings
('194B', NULL, 'Income by way of winnings from lotteries, crossword puzzles, card games, gambling', 'ALL', 1, 30.000, 1000000, 'Threshold: Rs. 10,000 per transaction', 'Form 16A', NULL),
...
('194BB', NULL, 'Income by way of winnings from horse races', 'ALL', 1, 30.000, 1000000, 'Threshold: Rs. 10,000 per transaction', 'Form 16A', NULL),

-- 194C: Contractors
('194C', 'a', 'Payment to contractor/sub-contractor — Individual/HUF', 'INDIVIDUAL_HUF', 1, 1.000, 3000000, 'Single: Rs. 30,000 | Aggregate FY: Rs. 1,00,000', 'Form 16A', NULL),
('194C', 'b', 'Payment to contractor/sub-contractor — Others (Company/Firm/etc.)', 'OTHERS', 1, 2.000, 3000000, 'Single: Rs. 30,000 | Aggregate FY: Rs. 1,00,000', 'Form 16A', NULL),

-- 194D: Insurance commission
('194D', NULL, 'Insurance commission', 'ALL', 1, 5.000, 1500000, 'Threshold: Rs. 15,000', 'Form 16A', NULL),

-- 194DA: Life insurance policy payment
('194DA', NULL, 'Payment in respect of life insurance policy', 'ALL', 1, 2.000, 10000000, 'Threshold: Rs. 1,00,000', 'Form 16A', NULL),

-- 194EE: NSS deposits
('194EE', NULL, 'Payment in respect of deposit under National Savings Scheme', 'ALL', 1, 10.000, 250000, 'Threshold: Rs. 2,500', 'Form 16A', NULL),
...
('194G', NULL, 'Commission on sale of lottery tickets', 'ALL', 1, 2.000, 1500000, 'Threshold: Rs. 15,000', 'Form 16A', NULL),

-- 194H: Commission/brokerage
('194H', NULL, 'Commission or brokerage', 'ALL', 1, 2.000, 1500000, 'Threshold: Rs. 15,000', 'Form 16A', NULL),

-- 194I: Rent
('194I', 'a', 'Rent — Plant and Machinery', 'ALL', 1, 2.000, 24000000, 'Threshold: Rs. 2,40,000 per annum', 'Form 16A', NULL),
('194I', 'b', 'Rent — Land or building or furniture or fitting', 'ALL', 1, 10.000, 24000000, 'Threshold: Rs. 2,40,000 per annum', 'Form 16A', NULL),
...
('194IB', NULL, 'Payment of rent by individual or HUF not liable to tax audit', 'INDIVIDUAL_HUF', 1, 2.000, 5000000, 'Threshold: Rs. 50,000 per month', 'Form 26QC', NULL),
...
('194J', 'a', 'Fees for technical services / royalty for cinematographic films / call centre', 'ALL', 1, 2.000, 3000000, 'Threshold: Rs. 30,000 per annum', 'Form 16A', NULL),
('194J', 'b', 'Fees for professional services — Any other sum', 'ALL', 1, 10.000, 3000000, 'Threshold: Rs. 30,000 per annum', 'Form 16A', NULL),

-- 194K: Income from units
('194K', NULL, 'Income in respect of units payable to resident person', 'ALL', 1, 10.000, 500000, 'Threshold: Rs. 5,000', 'Form 16A', NULL),
...
('194R', NULL, 'Deduction on benefit or perquisite provided arising from business/profession', 'ALL', 1, 10.000, 2000000, 'Threshold: Rs. 20,000 aggregate per FY', 'Form 16A', NULL),

-- 194S: Virtual Digital Assets
('194S', NULL, 'Payment on transfer of Virtual Digital Asset (VDA/Crypto)', 'ALL', 1, 1.000, 1000000, 'Threshold: Rs. 10,000 (specified person: Rs. 50,000)', 'Form 16A', NULL),

-- 194T: Partner payment from firm (effective 01-04-2025)
('194T', NULL, 'Payments of salary/remuneration/commission/bonus/interest to partner of firm', 'ALL', 1, 10.000, 2000000, 'Threshold: Rs. 20,000 aggregate per FY', 'Form 16A', 'Effective from 01-04-2025'),
...
('194T', NULL, 'Partner payment from firm — non-resident', 'ALL', 0, 10.000, 2000000, 'Threshold: Rs. 20,000', 'Form 16A', 'Effective from 01-04-2025'),
